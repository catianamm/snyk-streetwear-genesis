    ...
    <section ref={heroRef} className="relative bg-black text-white overflow-hidden">
      ...
      <div className="w-full min-h-[90vh] flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center items-start p-8 md:p-16 z-20 relative">
          ...
          {/* Decorative elements */}
          <div className="absolute top-10 right-10 w-24 h-24 border border-zinc-500 opacity-40 rotate-45"></div>
          <div className="absolute bottom-10 left-10 w-16 h-16 border border-zinc-400 opacity-30 -rotate-12"></div>
        </div>
        ...
        <div className="w-full md:w-1/2 relative overflow-hidden">
          ...
          <div className="relative h-full overflow-hidden">
            <img 
              ...
              alt="Fashion Model" 
              className={`w-full h-full object-cover parallax-img grayscale ${glitchActive ? 'glitch-img' : ''}`}
              data-speed="0.05"
            />
            ...
            <svg className="absolute inset-0 w-full h-full z-10 opacity-30" viewBox="0 0 100 100" preserveAspectRatio="none">
              ...
              <defs>
                <linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="100%">
                  ...
                  <stop offset="100%" stopColor="#cccccc" stopOpacity="0.3"></stop>
                </linearGradient>
              </defs>
            </svg>
          </div>
          ...
          <div className="absolute bottom-10 right-10 w-40 h-56 overflow-hidden border-2 border-white z-20
            ...
            <img 
              ...
              data-speed="0.1"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-zinc-500/30 to-transparent"></div>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="relative group">
            <div className="aspect-[4/5] overflow-hidden">
              ...
              <div className="absolute inset-0 bg-gradient-to-tr from-black/0 to-white/0 
                group-hover:from-black/30 group-hover:to-white/30 transition-all duration-500"></div>
            ...
            <div className="mt-4 flex justify-between items-end">
              <div>
                <h2 className="text-lg md:text-xl font-display uppercase mb-2 group-hover:text-white transition-colors">
                  SUMMER 2025
                </h2>
          ...
          <div className="relative group overflow-hidden">
            <div className="aspect-[4/5] overflow-hidden">
              <img 
                ...
                className="w-full h-full object-cover transition-all duration-700 group-hover:scale-110 group-hover:contrast-125 grayscale"
              />
              {/* Glitch effect on hover */}
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 
                bg-gradient-to-b from-transparent via-white/10 to-black/40"></div>
            ...
            <div className="mt-4 group-hover:translate-x-2 transition-transform duration-300">
              ...
              <Button asChild variant="outline" className="border-white text-white hover:bg-white hover:border-white 
                hover:text-black uppercase text-sm px-8 relative overflow-hidden group">

...
const Hero = () => {
  const { scrollIntensity, glitchActive, heroRef, textGlitch } = useScrollEffects();
      ...
      <section id="collections" className="min-h-screen py-16 bg-white overflow-hidden border-t border-zinc-800">
        ...
        <div className="container mx-auto px-4 md:px-8 lg:px-12 h-full flex flex-col">
          ...
          <div className="flex justify-center mt-40 pb-12">
            <Button asChild variant="outline" className="border-black bg-white text-black hover:bg-black hover:text-white uppercase text-sm px-10 relative overflow-hidden group">
              <Link to="/collections">

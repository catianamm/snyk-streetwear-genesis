    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
          ...
          <div className="container-custom">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
              <div className="flex flex-col items-center text-center p-4">
                <div className="h-16 w-16 rounded-full bg-snyk-purple/10 flex items-center justify-center mb-4">
        ...
        <section className="py-16 bg-black text-white overflow-hidden relative">
          <div className="absolute inset-0 opacity-20 bg-[url('https://images.unsplash.com/photo-1531297484001-80022131f5a1?q=80&w=1000')] bg-cover bg-center"></div>
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex justify-center space-x-8">
                <div className="text-center">
                  <span className="text-5xl font-display text-snyk-purple">00</span>
